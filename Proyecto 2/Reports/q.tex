...
\hline
 & A & B & C \\\hline
A & 0 & 3 & 19 \\\hline
B & 8 & 0 & \cellcolor{lightgreen} 27 \\\hline
C & $\infty$ & 4 & 0 \\\hline
\end{tabular}
...
A & 0 & 3 & 19 \\\hline
B & 8 & 0 & 27 \\\hline
C & \cellcolor{lightgreen} 12 & 4 & 0 \\\hline
\end{tabular}
...
\begin{itemize}
\item \textbf{A → B:} Distancia: 3, Ruta: A → B
\item \textbf{A → C:} Distancia: 19, Ruta: A → C
\item \textbf{B → A:} Distancia: 8, Ruta: B → A
\item \textbf{B → C:} Distancia: 27, Ruta: B → A → C
