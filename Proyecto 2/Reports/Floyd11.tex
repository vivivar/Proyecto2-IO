...
\hline
 & A & B & C \\\hline
A & 0 & $\infty$ & 2 \\\hline
B & 2 & 0 & \cellcolor{lightgreen} 4 \\\hline
C & $\infty$ & 15 & 0 \\\hline
\end{tabular}
...
A & 0 & $\infty$ & 2 \\\hline
B & 2 & 0 & 4 \\\hline
C & \cellcolor{lightgreen} 17 & 15 & 0 \\\hline
\end{tabular}
...
\hline
 & A & B & C \\\hline
A & 0 & \cellcolor{lightgreen} 17 & 2 \\\hline
B & 2 & 0 & 4 \\\hline
C & 17 & 15 & 0 \\\hline
\end{tabular}
...
\item \textbf{B → C:} Distancia: 4, Ruta: B → A → C
\item \textbf{C → A:} Distancia: 17, Ruta: C → B → A
